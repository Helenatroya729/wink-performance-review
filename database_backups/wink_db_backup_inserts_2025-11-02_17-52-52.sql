...
INSERT INTO public.employee_goals (id, user_id, cycle_id, goal_number, title, description, expected_deadline, expected_results, key_tasks, status, created_at, updated_at, rejection_comment, period_id) VALUES (13, 13, 1, 1, 'Изучить новые системы менеджмента', 'Описание', '2026-10-09', 'Результаты', 'Задачки', 'approved', '2025-11-02 17:23:07.98679', '2025-11-02 17:23:31.8775', NULL, NULL);
INSERT INTO public.employee_goals (id, user_id, cycle_id, goal_number, title, description, expected_deadline, expected_results, key_tasks, status, created_at, updated_at, rejection_comment, period_id) VALUES (14, 13, 2, 2, 'Цель', 'Описание', '2025-12-31', 'Результат результативный', 'Задачи', 'approved', '2025-11-02 17:26:04.419077', '2025-11-02 17:26:32.013774', NULL, NULL);
...
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (6, 9, 3, '• Отличное выполнение проекта по автоматизации HR-процессов
...
• Возглавить проект средней сложности (Q1 2026)', '2025-10-31 20:18:57.374814', true, '2025-10-31 20:18:57.374814', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (4, 10, 3, '• Успешно завершила проект по внедрению новой CRM системы
...
• Посетить конференцию по продажам (Q1 2026)', '2025-10-31 20:18:57.369584', false, '2025-10-31 20:18:57.369584', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (5, 13, 3, '• Реализовал 5 ключевых фич для мобильного приложения
...
• Изучить основы архитектуры микросервисов (Q1 2026)', '2025-10-31 20:18:57.372663', true, '2025-10-31 20:18:57.372663', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (7, 7, 3, '• Успешно руководил командой из 5 человек
...
• Пройти executive MBA или аналог (начать в Q2 2026)', '2025-10-31 20:18:57.377453', false, '2025-10-31 20:18:57.377453', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (8, 8, 3, '• Разработала новую систему подбора персонала
...
• Внедрить новую систему оценки кандидатов (Q1 2026)', '2025-10-31 20:18:57.380682', false, '2025-10-31 20:18:57.380682', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (10, 11, 3, '• Оптимизировал финансовые процессы компании
...
• Подготовить стратегический финансовый план на 3 года (Q1 2026)', '2025-10-31 20:18:57.384272', false, '2025-10-31 20:18:57.384272', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (9, 12, 3, '• Создала комплексную стратегию контент-маркетинга
...
• Запустить подкаст компании (Q1 2026)', '2025-10-31 20:18:57.382479', true, '2025-10-31 20:18:57.382479', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (11, 9, 3, 'Иван Иванов продемонстрировал высокие результаты в своей работе за оцениваемый период. Согласно самооценке, он оценил свою работу на 9.33/10, что свидетельствует о его высокой оценке своих достижений. 
...
Такой план позволит Ивану развить свои сильные стороны, улучшить слабые стороны и продвинуться в карьере.', '2025-11-02 14:21:39.247744', true, '2025-11-02 14:21:39.247744', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (12, 9, NULL, 'Иван Иванов продемонстрировал высокие результаты в своей работе за оцениваемый период. Он получил высокую самооценку - 9.33/10, что свидетельствует о его уверенности в своих достижениях. Оценка руководителя составила 8.0/10, что также является высоким показателем.
...
- Продолжать развивать лидерские качества и повышать результативность', '2025-11-02 14:32:44.863782', true, '2025-11-02 14:32:44.863782', 13);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (13, 12, NULL, '**Стиль управления:**
...
**Осторожно:** Может увлекаться креативом без анализа эффективности, требуйте метрики', '2025-11-02 16:58:52.76671', false, '2025-11-02 16:58:52.76671', 26);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (14, 7, NULL, '**Стиль управления:**
...
**Осторожно:** Может углубляться в операционку, напоминайте о стратегических задачах', '2025-11-02 16:58:52.777887', false, '2025-11-02 16:58:52.777887', 28);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (15, 8, NULL, '**Стиль управления:**
...
**Осторожно:** Может уделять слишком много внимания мероприятиям в ущерб аналитике', '2025-11-02 16:58:52.780504', false, '2025-11-02 16:58:52.780504', 29);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (16, 11, NULL, '**Стиль управления:**
...
**Осторожно:** Может слишком углубляться в детали, помогайте видеть "большую картину"', '2025-11-02 16:58:52.783287', false, '2025-11-02 16:58:52.783287', 32);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (17, 13, NULL, '**Стиль управления:**
...
**Осторожно:** Может уходить "в код" и игнорировать командную работу, следите за вовлеченностью', '2025-11-02 16:58:52.785782', true, '2025-11-02 16:58:52.785782', 33);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (18, 13, 3, 'Дмитрий Смирнов демонстрирует высокие результаты в своей работе, о чем свидетельствуют отзывы его коллег и оценка его работы в команде. Согласно отзывам, Дмитрий показывает отличные результаты в таких аспектах, как конструктивность в общении, профессионализм и готовность помогать коллегам. 
...
- Пройти оценку 360° повторно, чтобы отслеживать прогресс.', '2025-11-02 17:18:33.399271', false, '2025-11-02 17:18:33.399271', NULL);
INSERT INTO public.employee_recommendations (id, employee_id, hr_id, achievements, improvements, development_plan, sent_at, is_read, created_at, period_id) VALUES (19, 13, NULL, 'Дмитрий Смирнов демонстрирует высокие результаты в своей работе, о чем свидетельствуют отзывы его коллег и оценка его работы в команде. Согласно отзывам, Дмитрий показывает отличные результаты в таких аспектах, как конструктивность в общении, профессионализм и готовность помогать коллегам. 
...
6-12 месяцев:
- Рассмотреть возможность повышения в должности или расширения зоны ответственности.
- Пройти оценку 360° повторно, чтобы отслеживать прогресс.', '2025-11-02 17:19:03.88119', false, '2025-11-02 17:19:03.873532', 27);
...
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (34, 9, 'Performance Review 2025 - ноябрь', '2025-11-30', '2026-05-30', true, '2025-11-02 14:32:44.929427', 'not_started', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, 1, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (23, 9, 'Полугодие 2 - 2025 (Иван)', '2025-07-01', '2025-12-31', false, '2025-10-30 19:12:31.640948', 'not_started', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, 2, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (13, 9, 'Полугодие 1 - 2025 (Иван)', '2025-05-31', '2025-11-29', false, '2025-10-30 15:25:55.789972', 'completed', true, '2025-10-30 17:59:37.703606', 7, true, '2025-10-30 18:09:07.85143', 3, true, '2025-10-30 18:28:19.629138', 0, false, NULL, '2025-10-30 17:59:13.597189', true, '2025-10-30 20:56:21.568197', true, 1, true, '2025-11-02 14:32:44.873904');
...
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (27, 13, 'Полугодие 1 - 2025 (Дмитрий)', '2025-06-10', '2025-12-10', true, '2025-10-30 19:23:10.840883', 'completed', true, '2025-11-02 17:08:57.48686', 8, true, '2025-11-02 17:09:12.151164', 3, true, '2025-11-02 17:10:08.839224', 0, false, NULL, '2025-11-02 17:08:45.644077', true, '2025-11-02 17:16:29.576308', true, 1, true, '2025-11-02 17:19:03.880236');
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (21, 13, 'Полугодие 1 - 2024', '2024-01-01', '2024-06-30', false, '2025-10-30 15:25:55.805262', 'completed', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, NULL, false, NULL);
...
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (22, 13, 'Полугодие 2 - 2024', '2024-07-01', '2024-12-31', false, '2025-10-30 15:25:55.805262', 'completed', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, NULL, false, NULL);
...
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (16, 10, 'Полугодие 2 - 2024', '2024-07-01', '2024-12-31', false, '2025-10-30 15:25:55.796592', 'completed', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, NULL, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (15, 10, 'Полугодие 1 - 2024', '2024-01-01', '2024-06-30', false, '2025-10-30 15:25:55.796592', 'completed', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, '2025-10-30 16:18:16.212371', false, NULL, false, NULL, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (33, 13, 'Полугодие 2 - 2025 - Дмитрий Смирнов', '2025-07-01', '2025-12-31', false, '2025-10-31 19:41:11.031106', 'completed', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, 2, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (31, 10, 'Полугодие 2 - 2025 - Анна Сидорова', '2025-07-01', '2025-12-31', false, '2025-10-31 19:41:11.021946', 'awaiting_calculation', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, 2, false, NULL);
INSERT INTO public.employee_review_periods (id, user_id, name, start_date, end_date, is_active, created_at, status, manager_approved, manager_approved_at, manager_approved_by, hr_approved, hr_approved_at, hr_approved_by, self_assessment_completed, self_assessment_completed_at, peer_reviews_count, manager_evaluation_completed, manager_evaluation_completed_at, requested_early_at, manager_goals_evaluation_completed, manager_goals_evaluation_completed_at, peer_reviews_completed, cycle_id, potential_assessment_completed, calculated_at) VALUES (35, 13, 'Performance Review 2025 - декабрь', '2025-12-11', '2026-06-11', true, '2025-11-02 17:19:03.938081', 'not_started', false, NULL, NULL, false, NULL, NULL, false, NULL, 0, false, NULL, NULL, false, NULL, false, 1, false, NULL);
...
INSERT INTO public.manager_evaluations (id, employee_id, manager_id, cycle_id, professional_qualities_score, personal_qualities_score, communication_with_colleagues, employee_development_willingness, considers_as_successor, development_readiness, turnover_risk_score, priorities_from_opz, performance_total, potential_total, created_at, updated_at, result_achievement_rating, personal_qualities_comment, personal_contribution_comment, interaction_quality_rating, improvement_suggestions, overall_rating, feedback_summary, goal_id) VALUES (33, 13, 8, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-02 17:16:29.569919', '2025-11-02 17:16:29.569919', 6, 'Хорошая экспертиза, Прекрасная коммуникация с коллегами', 'Всегда помогает коллегам разбираться с трудными задачами!', 8, 'Быть более активным на проектах, хватает инициативности', 7, 'Общая оценка работы Дмитрия Смирнова за отчетный период - 7/10. Этот результат отражает как достижения, так и области для роста, которые я детально проанализирую ниже.
...
В заключение, я хочу отметить, что Дмитрий Смирнов является ценным членом команды и имеет большой потенциал для роста. С учетом рекомендаций и целенаправленной работы над развитием, я уверен, что Дмитрий сможет достичь еще более высоких результатов и внести еще больший вклад в команду.', NULL);
...
INSERT INTO public.manager_recommendations (id, employee_id, manager_id, hr_id, recommendations, sent_at, is_read, created_at, period_id) VALUES (8, 9, 7, 3, '## 1. ОБЩАЯ ОЦЕНКА И ВЫВОДЫ
...
Эти рекомендации направлены на сбалансированное развитие Ивана Иванова, удовлетворение его потребностей в росте и улучшение его вклада в достижение бизнес-целей компании.', '2025-11-02 14:32:44.870815', false, '2025-11-02 14:32:44.870815', 13);
INSERT INTO public.manager_recommendations (id, employee_id, manager_id, hr_id, recommendations, sent_at, is_read, created_at, period_id) VALUES (10, 13, 8, 3, '## 1. ОБЩАЯ ОЦЕНКА И ВЫВОДЫ
...
Эти рекомендации направлены на развитие потенциала Дмитрия, улучшение его вклада в достижение стратегических целей компании и повышение удовлетворенности работой.', '2025-11-02 17:18:59.146741', false, '2025-11-02 17:18:59.146741', NULL);
INSERT INTO public.manager_recommendations (id, employee_id, manager_id, hr_id, recommendations, sent_at, is_read, created_at, period_id) VALUES (11, 13, 8, NULL, '## 1. ОБЩАЯ ОЦЕНКА И ВЫВОДЫ
...
Эти рекомендации направлены на развитие потенциала Дмитрия, улучшение его вклада в достижение стратегических целей компании и повышение удовлетворенности работой.', '2025-11-02 17:19:03.882142', false, '2025-11-02 17:19:03.878499', 27);
...
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (23, 9, 'calculation_completed', 'Калькуляция завершена', 'Ваша оценка была рассчитана и рекомендации готовы. Теперь установите цели на следующий период (ID: 34).', 3, 13, false, NULL, '2025-11-02 14:32:44.931183');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (24, 7, 'calculation_completed', 'Калькуляция завершена для сотрудника', 'Калькуляция и рекомендации готовы для вашего сотрудника (periodId: 13).', 3, 13, false, NULL, '2025-11-02 14:32:44.932557');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (25, 8, 'early_pr_request', 'Запрос раннего Performance Review', 'Дмитрий Смирнов запросил ранний Performance Review', 13, 27, true, '2025-11-02 17:09:12.155238', '2025-11-02 17:07:47.706584');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (27, 8, 'early_pr_request', 'Запрос раннего Performance Review', 'Дмитрий Смирнов запросил ранний Performance Review', 13, 27, true, '2025-11-02 17:09:12.155238', '2025-11-02 17:08:45.647081');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (26, 13, 'early_pr_rejected', '❌ Запрос на досрочный Performance Review отклонен', 'Руководитель отклонил ваш запрос на досрочное начало Performance Review.

Причина: Слишком рано!

Вы можете подать новый запрос после устранения указанных замечаний.', NULL, 27, true, '2025-11-02 17:09:12.155238', '2025-11-02 17:08:28.15523');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (28, 3, 'early_pr_hr_approval', 'Требуется утверждение раннего PR', 'Руководитель утвердил ранний PR для Дмитрий Смирнов', 13, 27, true, '2025-11-02 17:09:12.155238', '2025-11-02 17:08:57.490817');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (29, 13, 'early_pr_approved', 'Ранний PR утвержден', 'Ваш запрос утвержден. Приступайте к самооценке и запросам обратной связи.', NULL, 27, true, '2025-11-02 17:09:12.155238', '2025-11-02 17:09:12.153317');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (30, 9, 'peer_feedback_request', 'Запрос на оценку', 'Дмитрий Смирнов запросил у вас peer review для периода "Полугодие 1 - 2025 (Дмитрий)"', 13, 44, false, NULL, '2025-11-02 17:10:41.473177');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (31, 11, 'peer_feedback_request', 'Запрос на оценку', 'Дмитрий Смирнов запросил у вас peer review для периода "Полугодие 1 - 2025 (Дмитрий)"', 13, 45, false, NULL, '2025-11-02 17:10:55.565445');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (32, 10, 'peer_feedback_request', 'Запрос на оценку', 'Дмитрий Смирнов запросил у вас peer review для периода "Полугодие 1 - 2025 (Дмитрий)"', 13, 46, false, NULL, '2025-11-02 17:11:13.123766');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (33, 8, 'peer_reviews_completed', 'Все peer отзывы получены', 'Дмитрий Смирнов получил все peer отзывы для периода "Полугодие 1 - 2025 (Дмитрий)". Можно переходить к оценке руководителя.', 13, NULL, false, NULL, '2025-11-02 17:14:15.489944');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (34, 8, 'potential_assessment_ready', 'Готово к оценке потенциала', 'Дмитрий Смирнов готов к оценке потенциала', 13, 27, false, NULL, '2025-11-02 17:16:29.58134');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (35, 13, 'potential_assessment_submitted', 'Оценка потенциала завершена', 'Руководитель завершил оценку вашего потенциала. Ожидайте расчета итогов.', 8, NULL, false, NULL, '2025-11-02 17:17:22.47509');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (36, 3, 'employee_ready_for_calculation', 'Сотрудник готов к калькуляции', 'Дмитрий Смирнов готов(а) к калькуляции.', 13, 1, false, NULL, '2025-11-02 17:17:22.48158');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (37, 13, 'calculation_completed', 'Калькуляция завершена', 'Ваша оценка была рассчитана и рекомендации готовы. Теперь установите цели на следующий период (ID: 35).', 3, 27, false, NULL, '2025-11-02 17:19:03.939534');
INSERT INTO public.notifications (id, user_id, type, title, message, related_user_id, related_id, is_read, read_at, created_at) VALUES (38, 8, 'calculation_completed', 'Калькуляция завершена для сотрудника', 'Калькуляция и рекомендации готовы для вашего сотрудника (periodId: 27).', 3, 27, false, NULL, '2025-11-02 17:19:03.94127');
...
INSERT INTO public.peer_feedback_requests (id, requester_id, reviewer_id, status, message, created_at, completed_at, period_id) VALUES (46, 13, 10, 'completed', 'Оцени пожалуйста!', '2025-11-02 17:11:13.11969', '2025-11-02 17:12:19.704962', 27);
INSERT INTO public.peer_feedback_requests (id, requester_id, reviewer_id, status, message, created_at, completed_at, period_id) VALUES (44, 13, 9, 'completed', 'Привет! Мы с тобой работали вместе! Оцени пожалуйста!', '2025-11-02 17:10:41.468302', '2025-11-02 17:13:06.086436', 27);
INSERT INTO public.peer_feedback_requests (id, requester_id, reviewer_id, status, message, created_at, completed_at, period_id) VALUES (45, 13, 11, 'completed', NULL, '2025-11-02 17:10:55.560898', '2025-11-02 17:14:15.484977', 27);
...
INSERT INTO public.peer_feedbacks (id, request_id, requester_id, reviewer_id, created_at, updated_at, result_achievement_rating, personal_qualities_comment, interaction_quality_rating, improvement_suggestions, period_id) VALUES (11, 46, 13, 10, '2025-11-02 17:12:19.701309', '2025-11-02 17:12:19.701309', 7, 'Упорство, лидерские качества!', 3, 'Иногда не вежливо общается', 27);
INSERT INTO public.peer_feedbacks (id, request_id, requester_id, reviewer_id, created_at, updated_at, result_achievement_rating, personal_qualities_comment, interaction_quality_rating, improvement_suggestions, period_id) VALUES (12, 44, 13, 9, '2025-11-02 17:13:06.079618', '2025-11-02 17:13:06.079618', 7, 'Отличная экспертиза!', 10, 'Отличная коммуникация! Всегда на связи', 27);
INSERT INTO public.peer_feedbacks (id, request_id, requester_id, reviewer_id, created_at, updated_at, result_achievement_rating, personal_qualities_comment, interaction_quality_rating, improvement_suggestions, period_id) VALUES (13, 45, 13, 11, '2025-11-02 17:14:15.476772', '2025-11-02 17:14:15.476772', 7, 'Высокая степень экспертизы', 10, 'Улучшить степень коммуникации с коллегами', 27);
...
INSERT INTO public.potential_assessments (id, employee_id, manager_id, cycle_id, prof_responsibility, prof_result_oriented, prof_proactivity, prof_open_mindset, prof_team_player, professional_comment, pers_took_responsibility, pers_transparent_communication, pers_shared_info, pers_organized_work, personal_comment, had_motivation_one_on_one, knows_miscommunication_cases, development_desire, is_successor, successor_ready_timing, turnover_risk, ole_priority_1, ole_priority_2, performance_raw_score, performance_final_score, potential_raw_score, potential_final_score, created_at, updated_at) VALUES (1, 9, 7, 1, true, true, true, true, false, '', false, true, false, false, '', false, false, 'proactive', false, '1-2_years', 6, 'Не понятно что тут писать ', '', 6, 2, 6, 6, '2025-10-30 21:25:12.919566', '2025-10-30 21:46:39.169038');
INSERT INTO public.potential_assessments (id, employee_id, manager_id, cycle_id, prof_responsibility, prof_result_oriented, prof_proactivity, prof_open_mindset, prof_team_player, professional_comment, pers_took_responsibility, pers_transparent_communication, pers_shared_info, pers_organized_work, personal_comment, had_motivation_one_on_one, knows_miscommunication_cases, development_desire, is_successor, successor_ready_timing, turnover_risk, ole_priority_1, ole_priority_2, performance_raw_score, performance_final_score, potential_raw_score, potential_final_score, created_at, updated_at) VALUES (2, 10, 7, 1, true, true, true, true, true, '', true, false, false, true, '', false, true, 'proactive', true, '1-2_years', 2, '', '', 5, 2, 10, 10, '2025-10-31 14:36:36.504821', '2025-10-31 14:36:36.504821');
...
INSERT INTO public.potential_assessments (id, employee_id, manager_id, cycle_id, prof_responsibility, prof_result_oriented, prof_proactivity, prof_open_mindset, prof_team_player, professional_comment, pers_took_responsibility, pers_transparent_communication, pers_shared_info, pers_organized_work, personal_comment, had_motivation_one_on_one, knows_miscommunication_cases, development_desire, is_successor, successor_ready_timing, turnover_risk, ole_priority_1, ole_priority_2, performance_raw_score, performance_final_score, potential_raw_score, potential_final_score, created_at, updated_at) VALUES (15, 13, 8, 1, true, true, false, false, true, '', true, true, false, false, '', true, true, 'proactive', true, '1-2_years', 4, '', '', 3, 0, 8, 8, '2025-11-02 17:17:22.463251', '2025-11-02 17:17:22.463251');
...
--
-- Name: employee_recommendations employee_recommendations_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
